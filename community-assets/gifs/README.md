...
The Android app reads `catalog.json` from this public repository. Use the local [GIF Studio](../../tools/gif-catalog-manager/README.md) or the [hosted GIF Studio](../../tools/gif-catalog-manager/hosted/README.md) to add and remove items; both save GIFs here and update the catalog.
