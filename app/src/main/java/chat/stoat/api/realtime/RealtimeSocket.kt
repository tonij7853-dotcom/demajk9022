    ...
    private suspend fun handleFrame(type: String, rawFrame: String) {
        when (type) {
            ...
            "Ready" -> {
                ...
                StoatAPI.saveSnapshotToDisk()
                Log.d("RealtimeSocket", "Socket ready — app data fully loaded and snapshot saved.")
            }
            ...
            "Message" -> {
                ...
                StoatAPI.unreads.recordIncomingMessage(messageFrame)
                ...
                messageFrame.channel?.let {
                    ...
                    StoatAPI.scheduleSnapshotSave(debounceMs = 3000L)
                }
            }
            ...
            "EmojiCreate" -> {
                ...
                if (emoji.id != null) {
                    StoatAPI.emojiCache[emoji.id!!] = emoji
                    StoatAPI.scheduleSnapshotSave()
                }
            }
